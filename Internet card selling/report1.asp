...
<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" bordercolorlight="#808080" bgcolor="#C0C0C0" height="37">
  <tr>
    ...
    <td width="14%" align="center" bgcolor="#FFCC66" height="7">
    <font color="#800000"><b><span lang="fa">&#1606;&#1608;&#1593; &#1705;&#1575;&#1585;&#1578;</span></b></font></td>
    <td width="13%" align="center" bgcolor="#FFCC66" height="7">
    <font color="#800000"><b><span lang="fa">&#1587;&#1585;&#1740;&#1575;&#1604;</span></b></font></td>
    <td width="16%" align="center" bgcolor="#FFCC66" height="7">
    ...
    do while Not objrs.Eof
     ...
     if (Clng(res1)<=r1 And r1<=Clng(res3) and a=objrs("TCARD")) then  
     
     sum=Clng(objrs("TCARD"))+sum
%>
...
<tr>
    ...
    <td width="14%" bgcolor="#FFFFFF" height="29">
    <p align="center"><font color="#000080"><%Response.write objrs("TCARD")%></font></td>
    <td width="13%" bgcolor="#FFFFFF" height="29">
    <p align="center"><font color="#000080"><span lang="fa"><%Response.write objrs("CID")%></span></font></td>
    <td width="16%" bgcolor="#FFFFFF" height="29">
