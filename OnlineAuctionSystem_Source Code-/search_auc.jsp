<%@ page language="java" import="java.io.*, java.sql.*, java.util.*,javax.servlet.*,javax.servlet.http.*,oracle.jdbc.driver.*,oracle.sql.*,oracle.ord.im.*" %>
...
String b = request.getParameter("T1");
   ...
   Statement stmt3 = conn.createStatement();
    ...
    ResultSet rs = stmt.executeQuery("SELECT * FROM AUC WHERE PNAME LIKE '%"+b+"%'");   
while (rs.next()){
int i=0;
